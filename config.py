...
symbol = ' !"#$%&\'()*+,-./:;<=>?@[]^_`{|}~¬°±²³·×÷Ÿƒʹː˚̀́̇̊́ΔΘΠΩαβγδθμπρσφωОио।ᅡᅥᅵ—―‖‘’‚“”„•․…‧′″※⃞℃℉ΩⅠⅡⅢⅣⅤⅥⅩⅰⅱⅲⅳⅴⅵ←↑→↓↔↖↗↘↙⇄⇋⇒⇔⇢⇣⇦⇧⇨⇩∅∆∇∈∉∋∓∕∖∗∘∙∝∞∠∣∥∧∨∩∪∴∵∶∼∽∾≐≒≠≡≤≥≦≧≪≫≳≺≻⊂⊃⊄⊏⊕⊖⊗⊘⊙⊚⊥⊳⊿⋂⋃⋄⋅⋆⋮⋯⋱⌊⌞〈〉⌾①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑴⑵⑶⑷⑸⑹⑺⑻⑼ⒶⒷⒸⒹⓐⓑⓒ─│╱▌▐■□▣▲△▶▷▼▽◀◆◇◈◉○◎●◐◑◦◯★☆☉☎☏☐☓☼♠♡♣♤♥♧♩♪♬✔✱✴✻✽❶❷❸❹❺❻➀➁➂➃➄➊➋➌➍➜➡➪⟂⟨⟩⟶⤴⦁⦵⦾⧹⨂⼆⼗⼤⼲⽀⽒⿃〈〉《》「」『』【】〓ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎㅏㅑㅓㅕㅗㅛㅜㅠㅡㅣㆍ㈀㈁㈂㈃㈄㈅㈎㈏㈐㈑㈒㈓㈕㉠㉡㉢㉣㉤㉥㉦㉧㉨㉩㉪㉫㉮㉯㉰㉱㉲㉳㉴㉵㉶㎎㎏㎝㎞㎠㎡㎤㎥一七三九二五位八六十四姓客尺搀板留程鵬六︳＃％（）＊＋，－．１３６７８９：＜＝＞？＠ＩＬＯＰ［］＾ｇｍ～｢｣ﾟ￡￦𝚤𝛼𝛽𝛾𝛿𝜂𝜃𝜅𝜆𝜇𝜋𝜌𝜎𝜏𝜑𝜔𝜙'
...
math = [
        '\\alpha', '\\begin', '\\beta', '\\cdot', '\\cdots', '\\cos', '\\cot', '\\csc', '\\end', '\\frac',
        '\\gamma', '\\hat', '\\hline', '\\infty', '\\int', '\\left', '\\leq', '\\ldots', '\\lim', '\\ln', '\\log', '\\max', '\\min', '\\not', '\\operatorname', '\\overbrace', '\\overleftarrow'
        '\\prod', '\\right', '\\sec', '\\sin', '\\sqrt', '\\sum', '\\overline', '\\phi', '\\pi',
        '\\theta',  '\\tan', '\\times', '\\quad', '\\qquad', '\\ddots',  '\\div', '\\dot', '\\underbrace', '\\underline', '\\varnothing', '\\vec'
        '\\Delta', '\\Lambda', '\\Rightarrow',
        '\\{', '\\}', '\\#', '\\%',
]
